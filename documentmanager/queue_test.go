...
func TestEnqueue1(t *testing.T) {
	q := NewQueue()
	result := q.Enqueue(QueueElem{Vector: NewTestVector(1, 0, 0), Id: A_ID, Version: 2}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: A_ID, Version: 3}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(3, 0, 0), Id: A_ID, Version: 4}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(5, 0, 0), Id: B_ID, Version: 1}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 0), Id: A_ID, Version: 1}, NewTestVector(0, 0, 0))
...
func TestEnqueue2(t *testing.T) {
	...
	result = q.Enqueue(QueueElem{Vector: NewTestVector(3, 0, 0), Id: A_ID, Version: 4}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: B_ID, Version: 1}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 0), Id: A_ID, Version: 1}, NewTestVector(0, 0, 0))
...
func TestEnqueue3(t *testing.T) {
	...
	result = q.Enqueue(QueueElem{Vector: NewTestVector(1, 0, 0), Id: A_ID, Version: 2}, NewTestVector(1, 0, 0))
	assertEqual(t, 1, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: A_ID, Version: 3}, NewTestVector(2, 0, 0))
	assertEqual(t, 1, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(3, 0, 0), Id: A_ID, Version: 4}, NewTestVector(3, 0, 0))
	assertEqual(t, 1, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: B_ID, Version: 1}, NewTestVector(4, 0, 0))
	assertEqual(t, 0, q.Size())
}
...
func TestEnqueue4(t *testing.T) {
	...
	result = q.Enqueue(QueueElem{Vector: NewTestVector(3, 0, 0), Id: A_ID, Version: 4}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(4, 2, 1), Id: A_ID, Version: 5}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 2, 0), Id: C_ID, Version: 1}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: B_ID, Version: 1}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 0), Id: A_ID, Version: 1}, NewTestVector(0, 0, 0))
	...
	result = q.Enqueue(QueueElem{Vector: NewTestVector(2, 0, 0), Id: B_ID, Version: 2}, NewTestVector(4, 1, 0))
...
func TestEnqueueDuplicateOperations(t *testing.T) {
	...
	assertEqual(t, 0, len(result))
	assertEqual(t, 1, q.Size())
	result = q.Enqueue(QueueElem{Vector: NewTestVector(1, 0, 1), Id: A_ID, Version: 2}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	assertEqual(t, 2, q.Size())
	result = q.Enqueue(QueueElem{Vector: NewTestVector(1, 0, 2), Id: A_ID, Version: 2}, NewTestVector(0, 0, 0))
	assertEqual(t, 0, len(result))
	assertEqual(t, 3, q.Size())
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 0), Id: C_ID, Version: 1}, NewTestVector(0, 0, 0))
	assertEqual(t, 1, len(result))
	assertEqual(t, 3, q.Size())
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 1), Id: C_ID, Version: 2}, NewTestVector(0, 0, 1))
	assertEqual(t, 1, len(result))
	assertEqual(t, 3, q.Size())
	result = q.Enqueue(QueueElem{Vector: NewTestVector(0, 0, 0), Id: A_ID, Version: 1}, NewTestVector(0, 0, 2))
